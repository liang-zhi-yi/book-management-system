...
{
    public partial class FrmBookCategoryManage : Form
    {
        // 业务逻辑对象
        private BookCategoryManager categoryManager = new BookCategoryManager();
        // 当前选中的类别ID（用于修改和删除）
        private int currentCategoryId = 0;
        // 当前模式：0-无，1-新增，2-修改
        private int currentMode = 0;

        public FrmBookCategoryManage()
        {
            InitializeComponent();
        }

        // 窗体加载时，加载数据
        private void FrmBookCategoryManage_Load(object sender, EventArgs e)
        {
            LoadCategoryData();
